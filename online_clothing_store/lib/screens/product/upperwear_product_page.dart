...
class UpperwearProductPage extends StatefulWidget {
  // static const String routeName = '/product';

  final Product product;
  UpperwearProductPage({
    Key? key,
    required this.product,
  }) : super(key: key);

  @override
  State<UpperwearProductPage> createState() => _UpperwearProductPageState();
}

class _UpperwearProductPageState extends State<UpperwearProductPage> {
  ...
  late final Stream<QuerySnapshot> reviewsStream = FirebaseFirestore.instance
      ...
      .snapshots();
  late int index = productController.upperwear.indexOf(widget.product);
                              ...
                              if (showDetails == true) ...[
                                ...
                                NeumorphicButton(
                                  ...
                                  onPressed: () => basketController.addProduct(
                                      productController.upperwear[index],
                                      index),
                                ),
                              ],
                              if (showReviews == true) ...[
